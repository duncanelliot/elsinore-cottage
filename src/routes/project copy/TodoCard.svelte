...
>
	...
	<div class="col-span-1 p-3 bg-white flex flex-col justify-between items-center">
		<button
			class="w-6 h-6 flex items-center justify-center text-gray-500 hover:text-gray-700 bg-white hover:bg-gray-50 border border-gray-300 rounded-full transition-all"
